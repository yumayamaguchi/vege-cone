              ...
              <div class="card h-100">
                  <a href="{{ route('products.show', ['product' => $category_product->id]) }}">
                      @if (!empty($category_product->image))
                          <img src="{{ asset('storage/image/' . $category_product->image) }}" class="card-img-top" alt="" width="200px"
                              height="250px" />
                      @else
                      ...
                      <div class="card-body">
                          ...
                          @if (Auth('web')->id() === $category_product->user_id)
                              ...
                              <div class="ml-auto card-text exit">
                                  <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right">
                                          <a class="dropdown-item" href="{{ route('products.edit', ['product' => $category_product]) }}">
                              ...
                              {{-- modal --}}
                              <div id="modal-delete-{{ $category_product->id }}" class="modal fade" tabindex="-1" role="dialog">
                                  <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                          ...
                                          <form method="POST" action="{{ route('products.destroy', ['product' => $category_product]) }}">
                                              @csrf
                                              @method('DELETE')
